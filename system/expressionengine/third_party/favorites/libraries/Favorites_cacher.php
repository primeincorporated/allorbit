 ...
 * @filesource	favorites/libraries/Favorites_cacher.php
 */
...
function thing($var)
{
	$cache = new Favorites_cacher(func_get_args(), __FUNCTION__, __CLASS__);
